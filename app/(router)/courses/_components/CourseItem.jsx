...
function CourseItem({ course }) {
  console.log("lansar",course); // Log the course object to ensure it has all the required properties
  ...
  return (
    <div className="border rounded-md hover:shadow-md dark:border-white/30 hover:scale-105 transform transition duration-300 hover:shadow-blue-300 dark:hover:shadow-white cursor-pointer">
      <Image
        src={course?.banner?.url || '/fallback-image.jpg'} // Fallback image if the URL is missing
        width={500}
        height={150}
        alt="banner"
